...
RcppExport SEXP _rlmtest_fLM(SEXP XrSEXP, SEXP yrSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fLM(Xr, yr));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_rlmtest_fLM", (DL_FUNC) &_rlmtest_fLM, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_rlmtest(DllInfo *dll) {
